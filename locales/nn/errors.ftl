# Feilmeldingar
error-generic = Ein feil oppstod
...
loading-pipelines = Lastar pipelines...
loading-agents = Lastar agentar...
loading-queues = Lastar køar...
loading-builds = Lastar bygg...

# Valideringsfeil
validation-required = Dette feltet er påkravd
validation-invalid-format = Ugyldig format
validation-too-short = For kort
validation-too-long = For langt
