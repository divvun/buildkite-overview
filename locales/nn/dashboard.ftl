...
stats-total-pipelines = Tal på pipelines
stats-running-pipelines = Køyrande pipelines
stats-pending-builds = Ventande bygg
stats-available-agents = Tilgjengelege agentar
stats-average-wait-time = Gjennomsnittleg ventetid
stats-p95-wait-time = 95. persentil ventetid
stats-p99-wait-time = 99. persentil ventetid
...
build-url-text = Vis bygg ↗
pipeline-url-text = Vis pipeline →
view-details = Vis detaljar
view-logs = Vis loggar
...
no-failing-pipelines-desc = Alle pipelines er for augneblinken friske.